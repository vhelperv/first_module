...
class __TwigTemplate_3632e09e9d127d6ee3b9250bc5e0158d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"cat\">
  <div class=\"cat__add\">
    <form id=\"cat-form\">
      ";
        // line 10
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["form"] ?? null), 10, $this->source), "html", null, true);
        echo "
    </form>
  </div>
</div>
